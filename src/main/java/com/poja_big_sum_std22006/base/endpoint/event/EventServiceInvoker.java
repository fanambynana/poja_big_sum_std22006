package com.poja_big_sum_std22006.base.endpoint.event;
...
public class EventServiceInvoker implements Consumer<EventConsumer.TypedEvent> {
  ...
  public void accept(EventConsumer.TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("com.poja_big_sum_std22006.base.endpoint.event.gen");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "com.poja_big_sum_std22006.base.service.event."
