package com.poja_big_sum_std22006.base.unit;
...
import com.poja_big_sum_std22006.base.endpoint.event.EventConsumer;
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent(
            "com.poja_big_sum_std22006.base.endpoint.event.gen.UuidCreated", payload);
